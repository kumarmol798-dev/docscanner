...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, l as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, m as lookupResultToBuffer, R as RequestStatusResponseStatus, U as UnknownError, n as RequestStatusDoneNoReplyErrorCode, o as RejectError, p as CertifiedRejectErrorCode, q as UNREACHABLE_ERROR, I as InputError, s as InvalidReadStateRequestErrorCode, t as ReadRequestType, v as Principal, w as IDL, x as MissingCanisterIdErrorCode, H as HttpAgent, y as encode, Q as QueryResponseStatus, z as UncertifiedRejectErrorCode, A as isV3ResponseBody, D as isV2ResponseBody, G as UncertifiedRejectUpdateErrorCode, J as UnexpectedErrorCode, K as decode, N as Subscribable, O as pendingThenable, V as resolveEnabled, W as shallowEqualObjects, X as resolveStaleTime, Y as noop, $ as environmentManager, a0 as isValidTimeout, a1 as timeUntilStale, a2 as timeoutManager, a3 as focusManager, a4 as fetchState, a5 as replaceData, a6 as notifyManager, a7 as hashKey, a8 as getDefaultState, r as reactExports, a9 as shouldThrowError, aa as useQueryClient, ab as useInternetIdentity, ac as createActorWithConfig, c as createLucideIcon, j as jsxRuntimeExports, b as cn, ad as Record, ae as Opt, af as Variant, ag as Vec, ah as Service, ai as Func, aj as Text, ak as Principal$1, al as Nat, am as Nat8, an as Bool, ao as Null, ap as Int, aq as React, u as useComposedRefs, ar as ReactDOM } from "./index-Bl6jr8gF.js";
import { u as useLayoutEffect2, P as Primitive, a as composeEventHandlers, e as dispatchDiscreteCustomEvent, d as useControllableState, g as createContext2, c as createContextScope, f as createSlot } from "./index-pyeuiCNz.js";
import { u as useCallbackRef$1, P as Presence } from "./index-uRdBZryN.js";
...
const PageInput = Record({
  "rotation": PageRotation$1,
  "blob": ExternalBlob$1,
  "ocrText": Opt(Text)
});
const DocumentId = Nat;
const AddPageRequest = Record({
  "page": PageInput,
  "documentId": DocumentId,
  "insertAtIndex": Opt(Nat)
});
const PageId = Nat;
...
const CreateDocumentRequest = Record({
  "name": Text,
  "pages": Vec(PageInput)
});
...
const ReorderPagesRequest = Record({
  "pageIds": Vec(PageId),
  "documentId": DocumentId
});
const RotatePageRequest = Record({
  "rotation": PageRotation$1,
  "documentId": DocumentId,
  "pageId": PageId
});
const UpdateDocumentNameRequest = Record({
  "id": DocumentId,
  "name": Text
});
Service({
  ...
  "addPage": Func([AddPageRequest], [PageId], []),
  "assignCallerUserRole": Func([Principal$1, UserRole], [], []),
  "createDocument": Func([CreateDocumentRequest], [Document], []),
  "deleteDocument": Func([DocumentId], [], []),
  "deletePage": Func([DocumentId, PageId], [], []),
  "getCallerUserProfile": Func([], [Opt(UserProfile)], ["query"]),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getDocument": Func([DocumentId], [Opt(Document)], ["query"]),
  "getUserProfile": Func(
    [Principal$1],
    [Opt(UserProfile)],
    ["query"]
  ...
  "listDocuments": Func([], [Vec(DocumentSummary)], ["query"]),
  "reorderPages": Func([ReorderPagesRequest], [], []),
  "rotatePage": Func([RotatePageRequest], [], []),
  "saveCallerUserProfile": Func([UserProfile], [], []),
  "saveOcrText": Func([DocumentId, PageId, Text], [], []),
  "searchDocuments": Func(
    [Text],
    [Vec(DocumentSummary)],
    ["query"]
  ),
  "updateDocumentName": Func([UpdateDocumentNameRequest], [], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const PageRotation2 = IDL2.Variant({
    "deg0": IDL2.Null,
    "deg180": IDL2.Null,
    "deg270": IDL2.Null,
    "deg90": IDL2.Null
  ...
  const PageInput2 = IDL2.Record({
    "rotation": PageRotation2,
    "blob": ExternalBlob2,
    "ocrText": IDL2.Opt(IDL2.Text)
  });
  const DocumentId2 = IDL2.Nat;
  const AddPageRequest2 = IDL2.Record({
    "page": PageInput2,
    "documentId": DocumentId2,
    "insertAtIndex": IDL2.Opt(IDL2.Nat)
  });
  ...
  const CreateDocumentRequest2 = IDL2.Record({
    "name": IDL2.Text,
    "pages": IDL2.Vec(PageInput2)
  });
  ...
  const Document2 = IDL2.Record({
    ...
    "pages": IDL2.Vec(Page2)
  });
  const UserProfile2 = IDL2.Record({ "name": IDL2.Text });
  const DocumentSummary2 = IDL2.Record({
    "id": DocumentId2,
    "name": IDL2.Text,
    "createdAt": Timestamp2,
    "updatedAt": Timestamp2,
  ...
  const ReorderPagesRequest2 = IDL2.Record({
    "pageIds": IDL2.Vec(PageId2),
    "documentId": DocumentId2
  });
  const RotatePageRequest2 = IDL2.Record({
    "rotation": PageRotation2,
    "documentId": DocumentId2,
    "pageId": PageId2
  });
  const UpdateDocumentNameRequest2 = IDL2.Record({
    "id": DocumentId2,
    "name": IDL2.Text
  });
  return IDL2.Service({
    ...
    "addPage": IDL2.Func([AddPageRequest2], [PageId2], []),
    "assignCallerUserRole": IDL2.Func([IDL2.Principal, UserRole2], [], []),
    "createDocument": IDL2.Func([CreateDocumentRequest2], [Document2], []),
    "deleteDocument": IDL2.Func([DocumentId2], [], []),
    "deletePage": IDL2.Func([DocumentId2, PageId2], [], []),
    "getCallerUserProfile": IDL2.Func([], [IDL2.Opt(UserProfile2)], ["query"]),
    "getCallerUserRole": IDL2.Func([], [UserRole2], ["query"]),
    "getDocument": IDL2.Func([DocumentId2], [IDL2.Opt(Document2)], ["query"]),
    ...
    "listDocuments": IDL2.Func([], [IDL2.Vec(DocumentSummary2)], ["query"]),
    "reorderPages": IDL2.Func([ReorderPagesRequest2], [], []),
    "rotatePage": IDL2.Func([RotatePageRequest2], [], []),
    "saveCallerUserProfile": IDL2.Func([UserProfile2], [], []),
    "saveOcrText": IDL2.Func([DocumentId2, PageId2, IDL2.Text], [], []),
    "searchDocuments": IDL2.Func(
      [IDL2.Text],
      [IDL2.Vec(DocumentSummary2)],
      ["query"]
    ),
    "updateDocumentName": IDL2.Func([UpdateDocumentNameRequest2], [], [])
  });
};
...
var PageRotation = /* @__PURE__ */ ((PageRotation2) => {
  PageRotation2["deg0"] = "deg0";
  PageRotation2["deg180"] = "deg180";
  PageRotation2["deg270"] = "deg270";
  PageRotation2["deg90"] = "deg90";
...
class Backend {
  ...
  async saveOcrText(arg0, arg1, arg2) {
    if (this.processError) {
      try {
...
async function from_candid_Document_n20(_uploadFile, _downloadFile, value) {
...
function from_candid_PageRotation_n25(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n26(_uploadFile, _downloadFile, value);
}
async function from_candid_Page_n23(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n26(_uploadFile, _downloadFile, value) {
  return "deg0" in value ? "deg0" : "deg180" in value ? "deg180" : "deg270" in value ? "deg270" : "deg90" in value ? "deg90" : value;
}
...
async function to_candid_AddPageRequest_n8(_uploadFile, _downloadFile, value) {
  return await to_candid_record_n9(_uploadFile, _downloadFile, value);
}
async function to_candid_CreateDocumentRequest_n17(_uploadFile, _downloadFile, value) {
...
async function to_candid_PageInput_n10(_uploadFile, _downloadFile, value) {
  return await to_candid_record_n11(_uploadFile, _downloadFile, value);
}
function to_candid_PageRotation_n12(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n13(_uploadFile, _downloadFile, value);
}
function to_candid_RotatePageRequest_n33(_uploadFile, _downloadFile, value) {
...
function useDocuments(searchQuery) {
...
function useUpdateDocumentName() {
  const { actor } = useActor(createActor);
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async (req) => {
...
export {
  ...
  useGetDocument as m,
  useDocuments as n,
  useDeleteDocument as o,
  useUpdateDocumentName as p,
  useCreateDocument as u
};
